...
title: Political Science 312, Spring 2026
---
...
Grades will be based on seven weekly hands-on group assignments (5% each for a total of 35%), in-class exercises and activities (35%), and a final group presentation (30%). A small amount of extra credit (up to 2%) is available for those who take on the role of discussants during the presentation period.

# Assignments

There are three categories of assignments spread throughout the quarter. First are weekly hands-on assignments (35% of the total grade) during the seven weeks before in-class presentations begin. These are a set of activities that you will carry out together with a stable research group to gradually develop a project that asks and answers a social-science question using the methods of quantitative research. The assignments are designed to split the process into manageable steps and generate measurable progress across the course of the quarter.
...
Presentation slides should be submitted on Canvas at least two hours before the start of class the day of the scheduled presentation.

# Late Work

Given the cumulative nature of work in this class, I strongly discourage you from falling behind. I will accept late work at a 10%-per-day penalty.
...
This schedule is subject to minor adjustments in pacing and some readings may be dropped or (in extreme cases) added depending on the needs of the class.

The main textbook for this course is The Effect by Nick Huntington-Klein, hosted for free at [https://theeffectbook.net/](https://theeffectbook.net/). The two chapters we use from Quan Li's book, Using R for Data Analysis in Social Sciences : A Research Project-Oriented Approach, are available in .pdf format on [the course github site](InClass/LiCh1and2.pdf). 
...
Before class, get a quick overview of the ideas in The Effect, Chapters 18-21
...
**Tuesday, April 28th: Social Science Transparency Practices**
...
**Tuesday, April 30th: Synthetic Control**
...
**Tuesday, May 5th: Regression-Discontinuity Designs**
...
**Thursday, May 7th: Instrumental Variables Designs**
...
**Tuesday, May 12th: Writing Quantitative Social Science**
...
of Politics*. 2022 84 (4): 2278-2282. 
...
**Thursday, May 14th: Missing Data**
...
**Tuesday, May 19th: Common Pitfalls**
